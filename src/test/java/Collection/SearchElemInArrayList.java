...
public class SearchElemInArrayList {
...
//create an ArrayList object
		...
		/*
		 * To check whether the specified element exists in Java ArrayList use boolean
		 * contains(Object element) method. It returns true if the ArrayList contains
		...
		/*
		 * To get an index of specified element in ArrayList use int indexOf(Object
		 * element) method. This method returns the index of the specified element in
		 * ArrayList. It returns -1 if not found.
		 */
